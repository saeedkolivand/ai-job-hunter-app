...
| **R3**  | `rusqlite::` only in `db.rs`, `error.rs`, and per-domain store `mod.rs`                                                                                                                                                                                                                                                                                                                    | arch test                              | infrastructure (`db`, `error`); domain stores (`documents`, `jobs`, `job_preferences`, `ai_generations`, `referrals`, `spend`, `applications`, `contact_profile`, `ai_config`, `dedup`, `discovered`, `email_watch`, `pipeline/cache`, `pipeline/runs`); external read (`scraping/board_login/import`)                                                                                                                                    |
...
| **R8**  | No source module > 1400 LOC (warn > 600)                                                                                                                                                                                                                                                                                                                                                   | arch test (soft)                       | the 10 W-6 files, capped at current size; may not grow                                                                                                                                                                                                                                                                                                                                                                                    |
