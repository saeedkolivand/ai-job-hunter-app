...
- **Model tier:** Claude Sonnet 5 for the CI gate (lower latency/cost than Opus for a deterministic diff review that doesn't need agency chains). Opus 5 still used for the on-demand `/review` deep dive (agent routing, inline comments).
