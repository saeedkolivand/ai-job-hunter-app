...
Last updated: 2026-07-28 (PRs #896–#897: aggregator page loop + spend budget, applications pipeline redesign)
...
| Authored pages as routes            | ✅     | 6 routes: home, creature, how-it-works, privacy, download (faithful port of legacy static site) + `/world` scroll-world (ADR-0019), all `src/app/`                                                      |
