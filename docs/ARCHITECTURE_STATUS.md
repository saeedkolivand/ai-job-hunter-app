...
| Jobs route                | ✅     | Master-detail split view (default) + list-only toggle; virtualized list via `@tanstack/react-virtual`; filter, interaction history, viewed/applied badges |
