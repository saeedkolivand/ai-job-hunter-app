...
| Feature                            | Status | Notes                                                                                                                                                                                          |
| ---------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Phase 1: Agent loop controller     | ✅     | Core loop, turn-by-turn control flow, streaming, tool routing. `run_agent_live`, `AgentStepKind`, `StoppedReason` (PR #547)                                                                    |
| Phase 2: "Prep application" flow   | ✅     | 4 read-only tools (research_company, match_resume, draft_cover_letter, suggest_interview_questions); fixed system prompt; trusted ToolContext; no Write tools; display-only proposal (PR #552) |
