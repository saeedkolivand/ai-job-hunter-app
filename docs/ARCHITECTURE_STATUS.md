...
| Accessibility conformance statement | 🚧     | Landing site + desktop app **partially conformant** with WCAG 2.2 AA; extension not assessed. Known barriers: landing (`/creature`, `/world`, `/architecture-map`), desktop renderer home view. See `/accessibility` and `NEXT_ISSUES` §accessibility-defects. PR #924 |
