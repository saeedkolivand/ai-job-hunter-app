...
| [../SCRAPING_ENDPOINTS.md](../SCRAPING_ENDPOINTS.md)             | Job-board endpoint reconnaissance snapshot (20 boards, 2026-06-20) — endpoint URLs, selectors, anti-bot status, priorities |
