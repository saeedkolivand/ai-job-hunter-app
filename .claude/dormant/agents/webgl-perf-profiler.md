...
rate ONLY. **First `Read` `.claude/dormant/skills/webgl-standards/SKILL.md`** (subagents don't auto-load
...
`.claude/dormant/skills/webgl-gate-audit/SKILL.md`). Read the FPS track. For the LOW-tier check,
...
Apply the ladder defined in `.claude/dormant/skills/webgl-standards/SKILL.md` (Budgets + quality governor)
