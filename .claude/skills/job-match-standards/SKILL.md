...
- **EU AI Act** (verified 2026-09-25): recruitment AI that sources/scores/ranks/shortlists CVs→JDs is **high-risk (Annex III)**. The Digital Omnibus on AI (**Regulation (EU) 2026/1744**, OJ 24 Jul 2026, in force 27 Jul 2026) moved Annex III high-risk obligations to **2 Dec 2027** — risk mgmt, human oversight, transparency, logging, conformity assessment; prepare for that date. Already applying: prohibited practices + AI literacy (since 2 Feb 2025) and **Art. 50 transparency** (since Aug 2026 — tell users when they interact with an AI system and disclose AI-generated content). https://usercentrics.com/knowledge-hub/eu-ai-act-high-risk-delay-article-50-transparency-consent/
