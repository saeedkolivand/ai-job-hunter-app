...
- **EU AI Act:** recruitment AI that sources/scores/ranks/shortlists CVs→JDs is **high-risk (Annex III)**. Per the early-May-2026 Omnibus deal the high-risk compliance deadline moved **2 Aug 2026 → 2 Dec 2027** (verify final enactment). Obligations: risk mgmt, human oversight, transparency, logging, conformity assessment. https://www.gibsondunn.com/eu-ai-act-omnibus-agreement-postponed-high-risk-deadlines-and-other-key-changes/
