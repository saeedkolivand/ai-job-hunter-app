...
`apps/tauri/src-tauri/src/commands/match_resume.rs`, `commands/cover_letter.rs`, `cover_letter/**`, `recommend/**`, `validate/**`, and JD-content prompts. Owns ATS _scoring/matching_ (ATS-safe _formatting_ → resume-export-author/pdf-docx-generator; provider _infra_ → ai-provider-author).
