...
2. Spawn the `job-match-expert` subagent (Agent) to extract: requirements, skills, technologies, industry classification, seniority — and how they map to the existing matching pipeline (`commands/match_resume.rs`).
