...
2. Run `graphify explain "ats scoring"`; then targeted-read the authoritative source (`commands/match_resume.rs`) and `docs/knowledge/resume-domain.md` (ATS section) for context. **Stop at ~90% confidence.**
