...
4. Spawn the `performance-profiler` subagent (Agent) over the target — hot paths only (async-runtime blocking, scraping concurrency, embeddings/streaming, layout/export, SQLite, large lists, token/cost).
