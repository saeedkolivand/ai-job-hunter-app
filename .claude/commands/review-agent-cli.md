...
4. Spawn **only** the `agent-cli-reviewer` subagent (Agent) as Primary Owner. Add `tauri-security-reviewer` as Secondary for any destructive verb, new data exposure, or auth change — **≤3 reviewers**.
