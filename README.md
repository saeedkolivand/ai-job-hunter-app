...
| <a href="[how-it-works](https://saeedkolivand.github.io/ai-job-hunter-assistant-app/how-it-works.html)" target="_blank" rel="noopener noreferrer">docs/landing/how-it-works.html</a>         | How the AI Job Hunter works end-to-end (interactive walkthrough) |
| <a href="[architecture-map](https://saeedkolivand.github.io/ai-job-hunter-assistant-app/architecture-map.html)" target="_blank" rel="noopener noreferrer">docs/landing/architecture-map.html</a> | Interactive architecture map of the AI Job Hunter                |
