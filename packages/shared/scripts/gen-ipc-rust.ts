...
function genBoardIds(): string {
  const decl = constSliceDecl(
    'BOARD_IDS',
    '&[&str]',
    BOARD_IDS.map((t) => JSON.stringify(t))
  );
  return [
    '// @generated by `pnpm gen:ipc` — DO NOT EDIT BY HAND.',
    '// Source of truth: packages/shared/src/schemas/index.ts',
...
function genMatchTiers(): string {
  return [
    ...
    `pub const MATCH_TIER_COVERAGE_HIGH: f64 = ${MATCH_TIER_CUTS.coverage.high}.0;`,
    '',
    '/// `coverage` Medium cut.',
    `pub const MATCH_TIER_COVERAGE_MEDIUM: f64 = ${MATCH_TIER_CUTS.coverage.medium}.0;`,
    '',
    "/// `combined` High cut — the semantic+ATS kernel's qualification bar.",
    `pub const MATCH_TIER_COMBINED_HIGH: f64 = ${MATCH_TIER_CUTS.combined.high}.0;`,
    '',
    '/// `combined` Medium cut.',
    `pub const MATCH_TIER_COMBINED_MEDIUM: f64 = ${MATCH_TIER_CUTS.combined.medium}.0;`,
    '',
  ].join('\n');
}
...
const outputs: { outFile: string; content: string }[] = [
  ...
  {
    outFile: 'apps/desktop/src-tauri/src/ipc_contracts/board_ids.rs',
    content: genBoardIds(),
  },
  {
  ...
  {
    outFile: 'apps/desktop/src-tauri/src/ipc_contracts/match_tiers.rs',
    content: genMatchTiers(),
  },
];
