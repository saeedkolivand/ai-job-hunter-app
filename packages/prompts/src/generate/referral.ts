...
4. Warm, specific, human, and brief — name the real role and company, anchor on one genuine, résumé-backed reason the candidate fits. No buzzwords ("passionate", "synergy", "results-driven"), no flattery padding.
...
- One or two short sentences: who the candidate is in a few words, the genuine fit, and the single ask. No greeting line and no sign-off block — there is no room.`;
    case 'linkedin_message':
      return `- A concise LinkedIn direct message. No hard character cap, but keep it tight — roughly 3–5 short sentences a busy person reads in one glance.
