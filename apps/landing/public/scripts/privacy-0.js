...
(function(){try{
  ...
  console.log('%cno analytics opened this console. the app reports crashes (opt-out) and nothing else. source 👉 https://github.com/saeedkolivand/ai-job-hunter-app', red);
