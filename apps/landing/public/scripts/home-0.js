...
(function(){
  try{
    ...
    console.log('%c(the code’s Apache-2.0 — yours to read, fork & sell. unlike my prospects. a few vendored datasets stay non-commercial though — see the LICENSE notes.)', soft);
  }catch(e){}
})();
