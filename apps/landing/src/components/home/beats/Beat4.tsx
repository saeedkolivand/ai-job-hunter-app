// Beat 4 — GODMODE <section> of / (home), split out of HomeBeats.tsx purely
// for file size — verbatim ported markup, no props. See HomeBody.tsx for
// the shared conversion notes; public/scripts/home-0.js binds to .sun-rays
// and [data-scream]/[data-voice]/[data-lines]/[data-to] by class/data-*
// (ADR-0018).
    ...
    <section className="stage beat4">
      ...
      <div className="inner">
        ...
        <p className="counter reveal">
          matches found: <span data-to="247">0</span> · drafts written: <span data-to="247">0</span>{' '}
          · applications you actually sent: <span data-to="6">0</span>
        </p>
        ...
        <p className="line reveal">
          runs 100% offline with Ollama. your 4am desperation is between you, your laptop, and God.
          not OpenAI. <b>God.</b>
        </p>
      </div>
    </section>
