...
**Settings:** an `options_ui` page, opened from the popup's "?" menu or the panel's gear icon — connection/pairing, the sites you've approved for Fill (with Forget), what the extension may do, appearance (theme, default panel tab, on-page extras), shortcuts, and privacy/about.
